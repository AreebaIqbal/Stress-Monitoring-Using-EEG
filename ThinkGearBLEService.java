...
public class ThinkGearBLEService extends Service implements BluetoothAdapter.LeScanCallback{
    ...
    public interface IThinkGearDataListener{
        ...
        void abc(ThinkGearBLEService thinkGearBLEService, logic Logic);
        ...
        private void parsePacketPayload(){
            ...
            switch (payload[0]) {
                ...
                case 0x02:{
                    ...
                    Logic.attention   = payload[29];
                    Logic.meditation  = payload[31];
                    ...
                    if (thinkGearDataListener != null){
                        thinkGearDataListener.abc(ThinkGearBLEService.this, Logic);
                    }
